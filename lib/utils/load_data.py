...
def load_proposal_roidb(dataset_name, image_set_name, root_path, dataset_path, result_path=None, proposal='rpn', append_gt=True, flip=False):
...
def load_gt_sdsdb(dataset_name, image_set_name, root_path, dataset_path, result_path=None, flip=False, mask_size=21, binary_thresh=0.4):
