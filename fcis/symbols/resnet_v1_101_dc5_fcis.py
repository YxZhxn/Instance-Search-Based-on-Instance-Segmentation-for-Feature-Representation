...
class resnet_v1_101_dc5_fcis(Symbol):
    ...
    def get_resnet_v1_conv4(self, data, is_train):
        ...
        """"""
        # res2a_branch2b_offset = mx.symbol.Convolution(name='res2a_branch2b_offset', data=res2a_branch2a_relu,
        #                                               num_filter=72, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
        #                                               cudnn_off=True)
        # res2a_branch2b = mx.contrib.symbol.DeformableConvolution(name='res2a_branch2b', data=res2a_branch2a_relu,
        #                                                          offset=res2a_branch2b_offset, num_filter=64,
        #                                                          pad=(1, 1), kernel=(3, 3), num_deformable_group=4,
        #                                                          stride=(1, 1), no_bias=True)
        """"""
        ...
        res2b_branch2b = mx.symbol.Convolution(name='res2b_branch2b', data=res2b_branch2a_relu, num_filter=64, pad=(1, 1),
                                               kernel=(3, 3), stride=(1, 1), no_bias=True)
        """"""
        # res2b_branch2b_offset = mx.symbol.Convolution(name='res2b_branch2b_offset', data=res2b_branch2a_relu,
        #                                               num_filter=72, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
        #                                               cudnn_off=True)
        # res2b_branch2b = mx.contrib.symbol.DeformableConvolution(name='res2b_branch2b', data=res2b_branch2a_relu,
        #                                                          offset=res2b_branch2b_offset,
        #                                                          num_filter=64, pad=(1, 1), kernel=(3, 3),
        #                                                          num_deformable_group=4, stride=(1, 1), no_bias=True)
        """"""
        ...
        res2c_branch2b = mx.symbol.Convolution(name='res2c_branch2b', data=res2c_branch2a_relu, num_filter=64, pad=(1, 1),
                                               kernel=(3, 3), stride=(1, 1), no_bias=True)
        """"""
        # res2c_branch2b_offset = mx.symbol.Convolution(name='res2c_branch2b_offset', data=res2c_branch2a_relu,
        #                                               num_filter=72, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
        #                                               cudnn_off=True)
        # res2c_branch2b = mx.contrib.symbol.DeformableConvolution(name='res2c_branch2b', data=res2c_branch2a_relu,
        #                                                          offset=res2c_branch2b_offset,
        #                                                          num_filter=64, pad=(1, 1), kernel=(3, 3),
        #                                                          num_deformable_group=4, stride=(1, 1), no_bias=True)
        """"""
        ...
        res3a_branch2b = mx.symbol.Convolution(name='res3a_branch2b', data=res3a_branch2a_relu, num_filter=128, pad=(1, 1),
                                               kernel=(3, 3), stride=(1, 1), no_bias=True)
        """"""
        # res3a_branch2b_offset = mx.symbol.Convolution(name='res3a_branch2b_offset', data=res3a_branch2a_relu,
        #                                               num_filter=72, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
        #                                               cudnn_off=True)
        # res3a_branch2b = mx.contrib.symbol.DeformableConvolution(name='res3a_branch2b', data=res3a_branch2a_relu,
        #                                                          offset=res3a_branch2b_offset, num_filter=128,
        #                                                          pad=(1, 1), kernel=(3, 3), num_deformable_group=4,
        #                                                          stride=(1, 1), no_bias=True)
        """"""
        ...
        """"""
        # res3b1_branch2b_offset = mx.symbol.Convolution(name='res3b1_branch2b_offset', data=res3b1_branch2a_relu,
        #                                                num_filter=72, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
        #                                                cudnn_off=True
        #                                                )
        # res3b1_branch2b = mx.contrib.symbol.DeformableConvolution(name='res3b1_branch2b', data=res3b1_branch2a_relu,
        #                                                           offset=res3b1_branch2b_offset,
        ...
        res3b2_branch2b = mx.symbol.Convolution(name='res3b2_branch2b', data=res3b2_branch2a_relu, num_filter=128,
                                                pad=(1, 1), kernel=(3, 3), stride=(1, 1), no_bias=True)
        """"""
        # res3b2_branch2b_offset = mx.symbol.Convolution(name='res3b2_branch2b_offset', data=res3b2_branch2a_relu,
        #                                                num_filter=72, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
        #                                                cudnn_off=True
        #                                                )
        # res3b2_branch2b = mx.contrib.symbol.DeformableConvolution(name='res3b2_branch2b', data=res3b2_branch2a_relu,
        #                                                           offset=res3b2_branch2b_offset,
        #                                                           num_filter=128, pad=(1, 1), kernel=(3, 3),
        #                                                           num_deformable_group=4, stride=(1, 1), no_bias=True
        #                                                           )
        """"""
    ...
    def get_resnet_v1_conv5(self, conv_feat):
        ...
        res5a_branch2b = mx.contrib.symbol.DeformableConvolution(name='res5a_branch2b', data=res5a_branch2a_relu,
                                                                 ...
                                                                 pad=(2, 2), kernel=(3, 3), num_deformable_group=4,
    ...
    def get_rpn(self, conv_feat, num_anchors):
        ...
        # the number of filters of the following two parallel convolution layers is depend on the number of anchors
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        if is_train:
            conv_feat = self.get_resnet_v1_conv4(data, is_train)
        else:
            conv_feat, res3b3_relu, res2c_relu = self.get_resnet_v1_conv4(data, is_train)
        ...
        if is_train:
            ...
            # classification loss for objectness
    ...
    def init_weight(self, cfg, arg_params, aux_params):
        ...
        """"""
        # arg_params['res2a_branch2b_offset_weight'] = mx.nd.zeros(shape=self.arg_shape_dict['res2a_branch2b_offset_weight'])
        # arg_params['res2a_branch2b_offset_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['res2a_branch2b_offset_bias'])
        # arg_params['res2b_branch2b_offset_weight'] = mx.nd.zeros(shape=self.arg_shape_dict['res2b_branch2b_offset_weight'])
        # arg_params['res2b_branch2b_offset_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['res2b_branch2b_offset_bias'])
        # arg_params['res2c_branch2b_offset_weight'] = mx.nd.zeros(shape=self.arg_shape_dict['res2c_branch2b_offset_weight'])
        # arg_params['res2c_branch2b_offset_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['res2c_branch2b_offset_bias'])
        """"""
        # arg_params['res3a_branch2b_offset_weight'] = mx.nd.zeros(shape=self.arg_shape_dict['res3a_branch2b_offset_weight'])
        # arg_params['res3a_branch2b_offset_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['res3a_branch2b_offset_bias'])
        # arg_params['res3b1_branch2b_offset_weight'] = mx.nd.zeros(shape=self.arg_shape_dict['res3b1_branch2b_offset_weight'])
        # arg_params['res3b1_branch2b_offset_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['res3b1_branch2b_offset_bias'])
        # arg_params['res3b2_branch2b_offset_weight'] = mx.nd.zeros(shape=self.arg_shape_dict['res3b2_branch2b_offset_weight'])
        # arg_params['res3b2_branch2b_offset_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['res3b2_branch2b_offset_bias'])
