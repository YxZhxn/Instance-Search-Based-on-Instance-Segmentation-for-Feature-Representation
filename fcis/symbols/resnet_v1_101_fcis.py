...
class resnet_v1_101_fcis(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        if is_train:
            ...
            rpn_bbox_loss_ = rpn_bbox_weight * mx.sym.smooth_l1(name='rpn_bbox_loss_',
                                                                scalar=3.0,
                                                                data=(rpn_bbox_pred - rpn_bbox_target))
            rpn_bbox_loss = mx.sym.MakeLoss(name='rpn_bbox_loss',
                                            data=rpn_bbox_loss_,
        ...
        fcis_bbox = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=7*7*4*num_reg_classes,
                                       name='fcis_bbox')  # 4 x K^2 x 2 score maps #
