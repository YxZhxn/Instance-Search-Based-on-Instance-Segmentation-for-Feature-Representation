...
class resnext_101_dc5_fcis(Symbol):
    ...
    def get_resnext_conv4(self, data, is_train, num_group=32):
        ...
        conv0 = mx.symbol.Convolution(name='conv0', data=data, num_filter=64, pad=(3, 3), kernel=(7, 7), stride=(2, 2),
                                      no_bias=True)
        bn0 = mx.symbol.BatchNorm(name='bn0', data=conv0, use_global_stats=True, fix_gamma=False,
                                  eps=self.eps)
        scale_conv0 = bn0
    ...
    def get_resnext_conv5(self, conv_feat, num_group=32):
        ...
        num_filter = 18 * num_deformable_group
        # res5a stage4 unit1
        # branch 1
        ...
        res5a_branch2b_offset = mx.symbol.Convolution(name='res5a_branch2b_offset', data=res5a_branch2a_relu,
                                                      num_filter=num_filter, pad=(2, 2), kernel=(3, 3), stride=(1, 1),
                                                      dilate=(2, 2), cudnn_off=True)
        res5a_branch2b = mx.contrib.symbol.DeformableConvolution(name='stage4_unit1_conv2', data=res5a_branch2a_relu,
                                                                 offset=res5a_branch2b_offset, num_filter=1024,
                                                                 pad=(2, 2), kernel=(3, 3), num_deformable_group=num_deformable_group,
        ...
        res5b_branch2b_offset = mx.symbol.Convolution(name='res5b_branch2b_offset', data=res5b_branch2a_relu,
                                                      num_filter=num_filter, pad=(2, 2), kernel=(3, 3), stride=(1, 1),
                                                      dilate=(2, 2), cudnn_off=True)
        res5b_branch2b = mx.contrib.symbol.DeformableConvolution(name='stage4_unit2_conv2', data=res5b_branch2a_relu,
        ...
        res5c_branch2b_offset = mx.symbol.Convolution(name='res5c_branch2b_offset', data=res5c_branch2a_relu,
                                                      num_filter=num_filter, pad=(2, 2), kernel=(3, 3), stride=(1, 1),
                                                      dilate=(2, 2), cudnn_off=True)
        res5c_branch2b = mx.contrib.symbol.DeformableConvolution(name='stage4_unit3_conv2', data=res5c_branch2a_relu,
